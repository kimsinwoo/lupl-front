...
import GoogleIcon from "../assets/google_icon_circle_24.svg";
import NaverIcon from "../assets/naver_icon_24.svg";
import KakaoSymbol from "../assets/kakao_symbol_black.svg";
...
const iconStyle = (iconSize: number): React.CSSProperties => ({
  width: px(iconSize),
  height: px(iconSize),
  display: "block",
});
